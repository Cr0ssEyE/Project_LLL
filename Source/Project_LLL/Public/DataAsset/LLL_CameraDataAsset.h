...
public:
	...
	UPROPERTY(EditDefaultsOnly, Category = "Camera", DisplayName = "종횡비 비율", meta=(EditCondition = "ProjectionType == ECameraProjectionMode::Orthographic && bUseConstraintAspectRatio == false", EditConditionHides))
	float AspectRatio;
